...
class TitleScreen:
   ...
   def run(self, screen, clock) -> bool:
       ...
       Ticks the clock each frame so no time accumulates while waiting.
       ...
       while True:
           ...
           screen.blit(self.title_surface, (width // 2 - self.title_surface.get_width() // 2, 150))
           screen.blit(self.subtitle_surface, (width // 2 - self.subtitle_surface.get_width() // 2, 280))
